...
var SlotMachine = function () {
  ...
  _createClass(SlotMachine, [{
    ...
    value: function _wrapTiles() {
      ...
      this._fakeFirstTile = this.tiles[this.tiles.length - 2].cloneNode(true);
      this.container.appendChild(this._fakeFirstTile);

      this._fakeFirstTile2 = this.tiles[this.tiles.length - 1].cloneNode(true);
      this.container.appendChild(this._fakeFirstTile2);
      ...
      this._fakeLastTile2 = this.tiles[1].cloneNode(true);
      this.container.appendChild(this._fakeLastTile2);

      this._fakeLastTile3 = this.tiles[2].cloneNode(true);
      this.container.appendChild(this._fakeLastTile3);
    }
  }, {
    key: '_setBounds',
